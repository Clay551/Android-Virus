...
|_|   \__,_|_|_| /_/   \_\___\___\___||___/___/

'
echo " " 
echo -e "$red #$pink HACKER $grn $red#$rset"
echo 
# Functions
...
echo -e '\e[91m
  ...
  ||    ||
'
echo -e "\e[93m                  Discord ID : clay332" | pv -qL 10
echo -e "\e[93m             ADMIN OF \e[92mClay" | pv -qL 10
echo -e "\e[93m             HOPE YOU LIKE THIS SCRIPT" | pv -qL 10
echo -e "\e[93m         Keep Supporting And Join Us " | pv -qL 10
echo -e "\e[93m         Join Us:\e[92m https://discord.gg/q64mv7Q3\e[0m" | pv -qL 10
